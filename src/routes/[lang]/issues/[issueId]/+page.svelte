...
<script lang="ts">
  ...
  export let data; // This contains issueId and issueNumber
</script>
...
<IssueLayout issueId={data.issueId} issueNumber={data.issueNumber}>
  ...
  <section id="why-pressing" class="py-16">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-6">
        {#each $_(`issues.${data.issueId}.key_aspects`) as aspect}
  ...
  <section class="py-16 bg-gray-50 dark:bg-gray-800">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="prose dark:prose-invert max-w-none">
        <ul class="space-y-4">
          {#each $_(`issues.${data.issueId}.connections_list`, {}, { default: [] }) as connection}
            <li class="flex gap-4">
  ...
  <section class="py-16">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-6">
        {#each $_(`issues.${data.issueId}.solutions_list`, {}, { default: [] }) as solution}
